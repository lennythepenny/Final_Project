...
# Add pixel count to training data
def extract_features_and_label(image, contour, label):
    ...
    return [area, perimeter, vertices, pixel_count, label]  # Return features and label
...
def main():
    ...
    for image_path in image_paths:
        ...
        # Save the processed image to the "final_images" folder
